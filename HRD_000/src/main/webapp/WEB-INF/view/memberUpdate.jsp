...
<jsp:include page="master/header.jsp"/>
    ...
    <div class="container">
    	...
    	<%
    	 MemberMoneyVO member = (MemberMoneyVO)request.getAttribute("member");
    	%>
    	<form action="memberUpdate" method="post" name="frm">
    		<table width="600px">
    			...
    			<tr>
    				<td>회원성명</td>
    				<td><input type="text"  value="${member.custname}" id="phone" name="phone"></td>
    			</tr>
    			<tr>
    				<td>회원전화</td>
    				<td><input type="text"  value="${member.phone}" id="address" name="address"></td>
    			</tr>
    			<tr>
    				<td>회원주소</td>
    			...
    			<tr>
    				<td>가입일자</td>
    				<td><input type="date"  value="${member.joindate}" id="joindate" name="joindate"></td>
    			</tr>
    			<tr>
